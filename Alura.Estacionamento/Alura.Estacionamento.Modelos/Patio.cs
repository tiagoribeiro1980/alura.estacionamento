...
namespace Alura.Estacionamento.Modelos
{
    public class Patio
    {
        ...
        public Veiculo AlteraDadosVeiculo(Veiculo veiculoAlterado)
        {
            ...
            var veiculoTemp = veiculos.SingleOrDefault(x => x.Placa == veiculoAlterado.Placa);
        ...
        public Veiculo PesquisaVeiculoPorTicket(string ticket)
        {
          ...
          //Código melhorado
          var encontrado = veiculos.SingleOrDefault(x => x.IdTicket == ticket); 
           return encontrado;
        }
        ...
        public Veiculo PesquisaVeiculoPorPlaca(string placa)
        {
            ...
            //Código melhorado
            var encontrado = veiculos.SingleOrDefault(x => x.Placa == placa);
        ...
        private string GerarTicket(Veiculo veiculo)
        {
            ...
            string ticket = "### Ticket Estacionameno Alura ###" +
                           ...
                           $">>> Operador Pátio: {OperadorPatio.Matricula}";
